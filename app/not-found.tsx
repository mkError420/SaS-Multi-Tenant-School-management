  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-slate-950 px-6 py-20 text-center">
      <div className="max-w-xl rounded-3xl border border-slate-800 bg-slate-900/95 p-10 shadow-soft">
        ...
        <h1 className="mt-4 text-4xl font-semibold text-white">Page or Tenant not found</h1>
        <p className="mt-4 text-slate-400">The page or school you’re looking for does not exist. Please check the URL or choose another tenant from the homepage.</p>
